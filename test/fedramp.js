...
if(self.activeSort){combinedFilterResults.sort(self.activeSort.sortFunc);}self.items=combinedFilterResults;self.doUpdate();}/**
     ...
     */function MenuController($state){var self=this;/**
         ...
         * state.
         */self.includes=$state.includes;}})();(function(){'use strict';angular.module('fedramp.components').component('navigation',{templateUrl:'templates/components/navigation.html',controller:Navigation,controllerAs:'controller'});Navigation.$inject=[];/**
     * @constructor
     * @memberof Components
     * @example <navigation />
     */function Navigation(){var self=this;/**
         ...
         */self.toggleMobile=false;}})();(function(){'use strict';angular.module('fedramp.components').component('panel',{transclude:true,templateUrl:'templates/components/panel.html',controller:Panel,controllerAs:'controller',bindings:{header:'@',iconClass:'@',expand:'<'}});Panel.$inject=[];/**
     * @constructor
     * @memberof Components
